...
var page_count;
var page_move;
var page_count_click;
var page_count_click_all;
...
var swipe_down_count;
var swipe_already_has;

var scrollbar_result;
var scroll_count;

var preventIpadgesture;
var animEndEventName;
var ignoreScrollEvents;
...
var touch_startX;
var touch_global_startX;
var touch_global_startY;

var touch_startY;
var touch_global_startendY;
var touch_global_startendX;

var touch_startTime;

var touch_global_resultX;
var touch_global_resultY;
...
var touch_swipedirection;
var touch_directionX;
var touch_directionY;
...
$(document).ready(function() {
    ...
    var select_content = document.querySelectorAll(".scroller");
	  for (count_m = 0; count_m < select_content.length; count_m++) {
   ...
   page_count_click_all = 0;
    ...
    nav:true,
    navText: [
      "<i class='icon-chevron-left icon-white'><span><</span></i>",
      "<i class='icon-chevron-right icon-white'><span>></span></i>"
      ],
  ...
  $("nav .page-nav-btn").each(function(index) { 
	...
	nav_arr.push( this_href );
	  ...
	  for (count_i = 0; count_i < each_page.length; count_i++) {
   ...
   function currentPosition() {
       ...
       nav_this_page_id = document.getElementsByClassName('pt-page-current')[0].id;
            ...
            for (count_m = 0; count_m < nav_arr.length; count_m++) {
   ...
   function menu() {
	 ...
	 for (count_z = 0; count_z < nav_arr.length; count_z++) {
		  if ($(".pt-page-current").attr('id') == nav_arr[count_z]) {
		    $('a[href*=#'+ nav_arr[count_z] +']').addClass("active");
		  }
     }
   ...
   $('.open-menu, .menu .close').on("click", function(event){
		...
		$iterate.on('click', function(event) {
		  ...
		  if (runing_move == 0) {
            ...
            if (this.getAttribute('data-id') == -1) {     // if scroll
                ...
                for (count_s = 0; count_s < pages_arr.length; count_s++) {
            ...
            this_clicked_href = nav_arr[this_clicked_id];
                ...
                for (count_f = 0; count_f < pages_arr.length; count_f++) {
